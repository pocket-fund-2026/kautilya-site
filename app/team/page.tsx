...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'DC.creator': 'Dev Shah',
    'DC.contributor': 'Aum Thakarkar, Ganesh Jagtap, Pushkar Rathod, Aryan Solanki, Kabir Dhumale, Aditya Negi',
    'DC.type': 'Text',
...
const teamSchema = {
  ...
  about: {
    ...
    name: 'Kautilya',
    url: BASE_URL,
    description: 'Buy-side M&A advisory firm. 7-person team covering deal sourcing, forensic DD, tech, AI workflows, and marketing.',
    employee: [
      {
        '@type': 'Person',
        name: 'Dev Shah',
      ...
      },
      {
        ...
        description: 'Works closely with leadership on high-impact projects, strategic initiatives, partnerships, and day-to-day execution across the firm.',
        nationality: 'Indian',
        worksFor: org,
      ...
      },
      {
        ...
        description: 'Provides timely technical assistance, resolves issues, and ensures smooth day-to-day use of our systems for clients and internal teams.',
        nationality: 'Indian',
        worksFor: org,
