...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'MSP due diligence', 'managed service provider acquisition',
...
const itemListSchema = {
  ...
  url: `${BASE}/stories`,
  description: '16 deal journals, case studies, and market intelligence articles from Kautilya\'s buy-side advisory practice.',
  numberOfItems: 16,
  itemListElement: [
    { '@type': 'ListItem', position: 1,  url: `${BASE}/stories/msp-buy-side-diligence`, name: 'How to Do Buy-Side Due Diligence on an MSP' },
    { '@type': 'ListItem', position: 2,  url: `${BASE}/stories/inspire3`,       name: 'How to Verify Revenue When Buying an Online Business (and Run Its Finances After)' },
    { '@type': 'ListItem', position: 3,  url: `${BASE}/stories/borderless`,     name: 'How to Source Off-Market Business Deals Without a Broker' },
    { '@type': 'ListItem', position: 4,  url: `${BASE}/stories/200k-deals`,     name: 'How We Closed $200K Worth of Deals in 6 Months' },
    { '@type': 'ListItem', position: 5,  url: `${BASE}/stories/smartprompt`,    name: 'When to Walk Away From an Acquisition (and How to Decide)' },
    { '@type': 'ListItem', position: 6,  url: `${BASE}/stories/runify`,         name: 'How to Buy a Business With Seller Financing (When the Revenue Isn\'t Proven Yet)' },
    { '@type': 'ListItem', position: 7,  url: `${BASE}/stories/dino-games`,     name: 'How to Value and De-Risk a Mobile Game Acquisition' },
    { '@type': 'ListItem', position: 8,  url: `${BASE}/stories/search-funds`,   name: 'The Rise of Search Funds' },
    { '@type': 'ListItem', position: 9,  url: `${BASE}/stories/diamonds`,       name: 'How to Find Diamonds in the Rough' },
    { '@type': 'ListItem', position: 10, url: `${BASE}/stories/deal-sourcing`,  name: 'My Morning Routine Is Looking at Acquire.com for 30 Minutes' },
    { '@type': 'ListItem', position: 11, url: `${BASE}/stories/sourcely`,       name: 'My First Bizness Acquisition: An AI Student Tool with $500 MRR for $4K' },
    { '@type': 'ListItem', position: 12, url: `${BASE}/stories/pocket-fund`,    name: 'The Pocket Fund: A Student-Led Acquisition Fund' },
    { '@type': 'ListItem', position: 13, url: `${BASE}/stories/college-startups`, name: '10 Reasons Why Now Is the Best Time to Start a Business in College' },
    { '@type': 'ListItem', position: 14, url: `${BASE}/stories/review`,         name: '2023 Review + 2024 Goals' },
    { '@type': 'ListItem', position: 15, url: `${BASE}/stories/pocket-deals`,   name: 'Pocket Deals #1: A $15K Micro-SaaS for Autism Support' },
    { '@type': 'ListItem', position: 16, url: `${BASE}/stories/edition-zero`,   name: 'Edition Zero: How This Is Bizness Began' },
  ],
};
