...
const itemListSchema = {
  ...
  numberOfItems: 16,
  itemListElement: [
    { '@type': 'ListItem', position: 1,  url: `${BASE}/stories/msp-buy-side-diligence`, name: 'Confidential MSP: Buy-Side DD on a $21M Managed-Services Business' },
    { '@type': 'ListItem', position: 2,  url: `${BASE}/stories/inspire3`,       name: 'Inspire3: Full-Scope DD on a $1.8M Digital Wellness Portfolio' },
    { '@type': 'ListItem', position: 3,  url: `${BASE}/stories/borderless`,     name: 'Rewriting the M&A Playbook for UK Immigration' },
    { '@type': 'ListItem', position: 4,  url: `${BASE}/stories/200k-deals`,     name: 'How We Closed $200K Worth of Deals in 6 Months' },
    { '@type': 'ListItem', position: 5,  url: `${BASE}/stories/smartprompt`,    name: 'SmartPrompt: Two Deals Killed, One Asset Acquired' },
    { '@type': 'ListItem', position: 6,  url: `${BASE}/stories/runify`,         name: 'Runify: Structuring a Mobile App Acquisition' },
    { '@type': 'ListItem', position: 7,  url: `${BASE}/stories/dino-games`,     name: 'Dino Games: Sourcing a Cash-Flow-Positive Mobile Game' },
